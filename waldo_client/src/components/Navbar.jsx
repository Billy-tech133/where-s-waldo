  ...
  return (
    ...
    <Link to='/' className='flex flex-col items-center'> <Home className='rounded-2xl bg-white shadow-md shadow-blue-400 font-light h-12 w-12 transition-transform transform hover:scale-110 cursor-pointer hover:shadow-lg' /> Home</Link>
        <ul className='flex space-x-8'>
            <Link to="/game" className='flex flex-col items-center'><Gamepad2 className='rounded-2xl bg-white shadow-md shadow-blue-400 font-light h-12 w-12 transition-transform transform hover:scale-110 cursor-pointer hover:shadow-lg' /> Game</Link>
